 ...
 * grid column (left 45%), not an absolutely-positioned overlay against a
 * centred container — that split reference frame is what caused the
 * earlier misalignment/clipping bug, so image and text stay in one grid.
 */
        ...
        <div className="bg-dotgrid relative flex items-center bg-ice-50 px-6 py-16 sm:px-10 lg:px-16">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="font-display text-4xl leading-[1.05] font-bold tracking-tight text-slag-900 sm:text-5xl xl:text-[3.75rem]">
              ...
              <span className="hero-line block">for heavy <span className="text-lichen-dark">industry.</span></span>
            </h1>
